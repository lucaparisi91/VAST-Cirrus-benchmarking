...
class Reframe(PythonPackage):
    ...
    depends_on("python@3.10:", when="@4.10:", type="run")
    ...
    depends_on("py-hatchling@1.29:",type="build",when="@4.10.0:")
    ...
    depends_on("py-urllib3", when="@4.10.0:", type="run")
    ...
    def setup_run_environment(self, env: EnvironmentModifications) -> None:
        env.prepend_path("MANPATH", self.prefix.share.man)
